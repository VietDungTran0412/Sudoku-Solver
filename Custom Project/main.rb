...
require "gosu"
# Require the set data structure to store unique elements
require "set"
# Require all class that were used
require_relative "class"
# Require a built-in Circlular Linked List data structure
# Circular Linked List is a complex data structure implementing
# to make the all the problem like an album where user can
# loop through it
...
class SudokuGameplay < Gosu::Window
	...
	def draw_difficulty(table)
		x = 100
		y = 20
		font = Gosu::Font.new(50)
		difficulty = table.difficulty
		color = get_font_color()
		font.draw("Difficulty: #{difficulty}",x,y,Zorder::UPPER,1,1,color)
	end
